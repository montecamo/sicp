...
/* Added by brg */
#define ARBITERP(x)	 TYPEP(x,tc_arbiter)
#define ARBLOCKEDP(x)	 (CAR(arb) == ((void *)1))
#define LOCKARB(x)	 (CAR(arb) = ((void *)1))
#define UNLOCKARB(x)	 (CAR(arb) = ((void *)0))
...
PRIMITIVE STk_clear_recursive_error(void);
...
extern int STk_line_eater_hungry;
...
PRIMITIVE STk_liststar2(SCM l, int len);	/* + */
...
extern SCM STk_transcript_port, STk_transcript_stdout, STk_transcript_stderr;
